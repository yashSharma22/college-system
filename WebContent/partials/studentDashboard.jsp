	...
	<div class="offcanvas-body p-0">
		<nav>
			<ul class="navbar-nav">
				...
				<li><a href="student_option.jsp" class="nav-link px-3 active"> <span
						class="me-2"><i class="bi bi-speedometer2"></i></span> <span>Dashboard</span>
				</a></li>
				<li><a href="Student_logout" class="nav-link px-3"> <span
						class="me-2"><i class="bi bi-box-arrow-right"></i></span> <span>Logout</span>
				</a></li>
				<li class="my-4">
					<hr class="dropdown-divider bg-light" />
				</li>
				<li><a href="student-result-list.jsp" class="nav-link px-3"> <span class="me-2"><i
							class="bi bi-book-fill"></i></span> <span>Results</span>
				</a></li>
				<li class="my-4">
					<hr class="dropdown-divider bg-light" />
				</li>
