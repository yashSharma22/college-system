        ...
        <div class="container-fluid mt-5">
            <div class="row justify-content-center">
                ...
                <div class="col-11 col-sm-10 col-md-6 col-lg-5 mb-5 offset-lg-1">
                    <form action="Create_exam" method="post" onsubmit="return examRegisterValidate('examName', 'msg1', 'Enter Exam Name', 
                                                                'examDate', 'msg2', 
                                                                'examTime', 'msg3', 
                        ...
                        <div class="row">
                            <div class="col-12 col-md-9 col-lg-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date" class="form-control" id="examDate"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="time" class="form-control" id="examTime"
                                ...
                                <div class="mb-3">
                                    <label for="examDuration" class="form-label text-uppercase fw-bold">Duration
                                        (minutes)</label>
                                    <input type="number" name="dtime" class="form-control" id="examDuration"
                                ...
                                <div class="mb-3">
                                    <label for="noOfQues" class="form-label text-uppercase fw-bold">No. of
                                        Questions</label>
                                    <input type="number" name="noOfQues" class="form-control" id="noOfQues"
                                ...
                                <div class="mb-3">
                                    <label for="pmark" class="form-label text-uppercase fw-bold">Positive
                                        Marking</label>
                                    <input type="number" name="pmarks" class="form-control" id="pmark"
                                ...
                                <div class="mb-3">
                                    <label for="nmark" class="form-label text-uppercase fw-bold">Negative
                                        Marking</label>
                                    <input type="number" name="nmarks" class="form-control" id="nmark"
