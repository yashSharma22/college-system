		...
		<div class="row justify-content-center">
			...
			<div class="col-11 col-sm-10 col-md-6 col-lg-5 mb-5 offset-lg-1">
				<form action="Add_question" method="post"
					...
					class="mt-5">
					<h1 class="fw-bold mb-5">Add Question</h1>
					<div class="row">
						<div class="col-12 col-md-9 col-lg-9">
							<div class="mb-3">
								<label for="examName" class="form-label text-uppercase fw-bold">Exam</label>
								<select name="examid" class="form-select form-control"
							...
							<div class="mb-3">
								...
								<textarea name="ques" class="form-control" id="question"
									rows="3"
									onfocusout="namevalidation('question','msg1','Enter Question')"></textarea>
							...
							<div class="mb-3">
								<label for="coption" class="form-label text-uppercase fw-bold">Choose
									Correct Option</label> <select name="coption"
							...
							<button type="submit"
								class="btn landing-page-btn text-white fs-5 py-2 w-100">ADD</button>
						</div>
					</div>
				</form>
			</div>
