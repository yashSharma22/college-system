        ...
        <div class="container-fluid mt-5">
            <div class="row justify-content-center">
                ...
                <div class="col-11 col-sm-10 col-md-6 col-lg-5 mb-5 offset-lg-1">
                    <form action="Update_exam" method="post" onsubmit="return examRegisterValidate('examName', 'msg1', 'Enter Exam Name', 
                                                                'examDate', 'msg2', 
                                                                'examTime', 'msg3', 
                                                                'examDuration', 'msg4', 'Enter Valid Duration', 
                                                                'noOfQues','msg5', 'Invalid!', 
                                                                'pmark','msg6','Invalid!', 
                                                                'nmark','msg7','Invalid!')" class="mt-5">
                        <h1 class="fw-bold mb-5">Update Exam</h1>
                        <h4>Exam Id: <%=request.getParameter("examId") %></h4>
                        <input name="eid" type="hidden" value="<%=request.getParameter("examId") %>">
                        <div class="row">
                            <div class="col-12 col-md-9 col-lg-9">
                                <div class="mb-1">
                                    <label for="examName" class="form-label text-uppercase fw-bold">Exam Name</label>
                                    <input type="text" name="examName" class="form-control" id="examName" value="<%=request.getParameter("examName") %>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date" class="form-control" id="examDate" value="<%=request.getParameter("examDate") %>"
                                        onfocusout="datevalidation('examDate','msg2')">
                                    <div id="msg2" class="error-text">&nbsp;</div>
                                </div>
                                <div class="mb-3">
                                    <label for="examTime" class="form-label text-uppercase fw-bold">Start Time</label>
                                    <input type="time" name="time" class="form-control" id="examTime" value="<%=request.getParameter("startTime") %>"
                                        onfocusout="timevalidation('examTime','msg3')">
                                    <div id="msg3" class="error-text">&nbsp;</div>
                                </div>
                                <div class="mb-3">
                                    <label for="examDuration" class="form-label text-uppercase fw-bold">Duration
                                        (minutes)</label>
                                    <input type="number" name="dtime" class="form-control" id="examDuration" value="<%=request.getParameter("dTime") %>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="deptid" class="form-select form-control" aria-label="Default select example">
                                        <%
                                ...
                                <div class="mb-3">
                                    <label for="noOfQues" class="form-label text-uppercase fw-bold">No. of
                                        Questions</label>
                                    <input type="number" name="noOfQues" class="form-control" id="noOfQues" value="<%=request.getParameter("totalQues") %>"
                                ...
                                <div class="mb-3">
                                    <label for="pmark" class="form-label text-uppercase fw-bold">Positive
                                        Marking</label>
                                    <input type="number" name="pmarks" class="form-control" id="pmark" value="<%=request.getParameter("pmarks") %>"
                                ...
                                <div class="mb-3">
                                    <label for="nmark" class="form-label text-uppercase fw-bold">Negative
                                        Marking</label>
                                    <input type="number" name="nmarks" class="form-control" id="nmark" value="<%=request.getParameter("nmarks") %>"
