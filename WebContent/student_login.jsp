        ...
        <div class="container-fluid mt-5">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-11 col-sm-10 col-md-6 col-lg-4 mb-5">
                    <form action="Student_login" method="post" onsubmit="return userLoginValidate('userId', 'msg1', 'userPassword', 'msg2')" class="mt-5">
                        <h1 class="fw-bold mb-5">Student Login</h1>
                        <div class="row">
                            <div class="col-12 col-md-9 col-lg-9">
                                <div class="mb-3">
                                    <label for="userId" class="form-label text-uppercase fw-bold">User Id</label>
                                    <input type="number" name="sid" class="form-control" id="userId"
